...
2. [Novos Menus ao Acessar um Dispositivo](novos-menus-ao-acessar-um-dispositivo.md)
3. [Adicionada Função para Alterar Papel de Parede](adicionada-funcao-para-alterar-papel-de-parede.md)
...
8. [Nova Funcionalidade para Remoção do Bloqueio de Chip Remotamente](nova-funcionalidade-para-remocao-do-bloqueio-de-chip-remotamente.md)
...
11. [Configurações de Bluetooth no Mob Settings](configuracoes-de-bluetooth-no-mob-settings.md)
