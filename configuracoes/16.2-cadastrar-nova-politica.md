...
Após o cadastro da política será aberta a tela "**Editar Política**" para que os detalhes da política sejam configurados. A seção <mark style="background-color:purple;">**16.1.1**</mark> mostra os detalhes da configuração de políticas.
